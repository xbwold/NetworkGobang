...
public class MainPage extends JFrame implements MouseListener, MouseMotionListener, ActionListener {
	...
	public JButton remake; // 悔棋及认输都需要到自己下棋才能操作
	public JButton lose;
	public JButton quit;
...
//	}
	...
	private void initLeftJPane() {
		...
		head1.setPreferredSize(new Dimension(100, 100));// 设置大小
	...
	private void initRightJPane() {
		...
		start.setPreferredSize(new Dimension(200, 50));// 设置大小
		...
		JScrollPane scrollpane = new JScrollPane(showMessage); // 实现滚动体
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == start) { //准备游戏
			...
			if (player.getRecord().getSize() >= 2) {
				...
				JOptionPane.showMessageDialog(this, "步数不够，无法悔棋", "提示", JOptionPane.INFORMATION_MESSAGE);
			}
