...
//	}
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == create) { // 创建房间
			...
			mainPage = new MainPage(this.name, "等待玩家加入", clinet);
			...
			if (row == -1) {
				JOptionPane.showMessageDialog(this, "请先选择房间", "提示ʾ", JOptionPane.WARNING_MESSAGE);
			} else {
				...
				if (name.equals("等待玩家加入")) {
					...
					JOptionPane.showMessageDialog(this, "房间已满", "提示ʾ", JOptionPane.WARNING_MESSAGE);
				}
